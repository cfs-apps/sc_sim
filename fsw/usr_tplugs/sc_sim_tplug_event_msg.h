...
**
** Purpose:
**   Export SC_SIM's TPLUG Event Message constructor
**
** Notes:
...
#ifndef _sc_sim_tplug_event_msg_
#define _sc_sim_tplug_event_msg_
...
**
** Initialize the SC_SIM TPLUG JMSG Event Playback topic
**
** Notes:
**   None
**
...
**
** Notes:
**   1. Main use case is for replacing double quotes with single quotes in
**      JSON messages.
**
*/
...
#endif /* _sc_sim_tplug_event_msg_ */
